...
// My guardian API key 5db8f31e-d4d1-400c-bf8c-36be282812df

func main() {
	client := gocapiclient.NewGuardianContentClient("https://content.guardianapis.com/", "5db8f31e-d4d1-400c-bf8c-36be282812df")
	searchQuery(client)
